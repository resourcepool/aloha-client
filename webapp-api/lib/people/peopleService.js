...
const insert = async (reqBody) => {
  ...
  let params = [uuidv4(), _capitalize(reqBody.firstName), _capitalize(reqBody.lastName), reqBody.status, reqBody.description, JSON.stringify(reqBody.tags), JSON.stringify(_getKeywords(reqBody))];
